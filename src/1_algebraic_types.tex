\section{Algebraic Types}
  ...
  \subsection{Types 4-6: $m\degree$ Polynomial over $\sqrt{n\degree}$ Polynomial}
    ...
    \subsection{Type 10: Inverse of $1\degree$ Polynomial multiplied by $\sqrt{2\degree}$ Polynomial}
      ...
      \begin{flalign*}
        ...
        & = \int \frac{-\frac{1}{z^2}\mathrm{d}z}{\frac{1}{z}\sqrt{3(\frac{1}{z}-1)^2 + 2(\frac{1}{z}-1)+1}} & x=\frac{1}{z}-1 &\ \rightarrow \mathrm{d}z=-\frac{1}{x^2}\mathrm{d}x \\
    ...
    \subsection{Type 11: Inverse of $1\degree$ Polynomial multiplied by $n\degree$ Polynomial}
      ...
      \begin{flalign*}
        & \int \frac{\mathrm{d}x}{x(4+5x^{20})} & let \ x^{20}=\frac{1}{z} \ \rightarrow 20\ln{x} = -\ln{z} &\\
        & = -\frac{1}{20} \int \frac{\mathrm{d}z}{z(4+\frac{5}{z})} & \rightarrow 20\frac{\mathrm{d}x}{x} = -\frac{\mathrm{d}z}{z} \\
        & = -\frac{1}{20} \int \frac{\mathrm{d}z}{4z+5} \\
        & = -\frac{1}{80}\ln{|4z+5|} + c        
      \end{flalign*}

    \subsection{Type 12: Inverse of $1\degree$ Polynomial multiplied by $\sqrt{n\degree}$ Polynomial}
      ...
      \begin{flalign*}
        & \int \frac{\mathrm{d}x}{x\sqrt{5+x^{\frac{1}{3}}}} & let \ x^{\frac{1}{3}}=\frac{1}{z^2} \ \rightarrow \frac{1}{3}\ln{x} = -2\ln{z} &\\
        & = -6\int \frac{\mathrm{d}z}{z\sqrt{5+\frac{1}{z^2}}} & \rightarrow \frac{1}{3}\frac{\mathrm{d}x}{x} = -2\frac{\mathrm{d}z}{z} \\
